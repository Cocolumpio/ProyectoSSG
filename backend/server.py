...
async def listar_solicitudes_vuelo():
    """Listar todas las solicitudes de vuelo"""
...
async def actualizar_estado_solicitud(solicitud_id: str, estado: str):
    """Actualizar el estado de una solicitud de vuelo"""
    ...
    result = await db.solicitudes_vuelo.update_one(
        {"id": solicitud_id},
        {"$set": {"estado": estado}}
    )
